...
export const Homepage = () => {
    ...
    return (
        <>
            ...
            <div id='products' className="py-80">
                <div className="container">
            ...
            <div id="process" className='ad-process py-80'>
                <div className="container">
                    <div className="row justify-content-center">
                    <div className="col-lg-7 text-center">
                        <div className="ad-text-label text-uppercase text-xs font-weight-700 text-primary mb-4"><u>Our
                            Process</u></div>
                        <h2 className='mb-2 px-lg-5'>From Exploration to Continuous Optimization</h2>
                        <p className='mb-3 px-lg-5'>Embark on a streamlined Process, navigating through exploration, crafting, automation, integration, and perpetual operation.</p>
                    </div>
                    </div>

                    <div className="row justify-content-center mb-5">
                        <div className="col-lg-7">
                            <article className='border-top border-bottom py-5'>
                                <div className="row align-items-center">
                                    <div className="col-md-5 mb-3 mb-md-0">
                                        <div className="ad-card bg-dark">
                                            <div className="ad-card-body">
                                                <h4 className='pb-0'><span className='ad-num-count'>1</span> Discover</h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <article className='border-top border-bottom py-5'>
                                <div className="row align-items-center flex-md-row-reverse">
                                    <div className="col-md-5 mb-3 mb-md-0">
                                        <div className="ad-card bg-dark">
                                            <div className="ad-card-body">
                                                <h4 className='pb-0'><span className='ad-num-count'>2</span> Development</h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <article className='border-top border-bottom py-5'>
                                <div className="row align-items-center">
                                    <div className="col-md-5 mb-3 mb-md-0">
                                        <div className="ad-card bg-dark">
                                            <div className="ad-card-body">
                                                <h4 className='pb-0'><span className='ad-num-count'>3</span> Automate & Integrate
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <article className='border-top border-bottom py-5'>
                                <div className="row align-items-center flex-md-row-reverse">
                                    <div className="col-md-5 mb-3 mb-md-0">
                                        <div className="ad-card bg-dark">
                                            <div className="ad-card-body">
                                                <h4 className='pb-0'><span className='ad-num-count'>4</span> Operate & Maintain</h4>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="row justify-content-center mt-80">
                        <div className="col-lg-10">
                            <div className="ad-videoWrapper mb-0">
                                <iframe src="https://www.youtube.com/embed/-92Ds-Vmyyw?si=Dj1JnzIkISMZShR9" title="YouTube video player" border="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-lg-4 col-md-6 mb-4">
                            <div className="ad-card bg-grey text-center">
                                <div className="ad-card-body">
                                    ...
                                    <h4>Industrial</h4>
                                    <p className='pb-0'>Improved precision, increased production efficiency, and reduced labor costs.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 mb-4">
                            <div className="ad-card bg-grey text-center">
                                <div className="ad-card-body">
                                    ...
                                    <p className='pb-0'>Increased agricultural efficiency, reduced labor dependence, and optimized resource use.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 mb-4">
                            <div className="ad-card bg-grey text-center">
                                <div className="ad-card-body">
                                    ...
                                    <h4>Healthcare</h4>
                                    <p className='pb-0'>Enhanced precision in surgery, improved patient care, and support for healthcare professionals.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 mb-4">
                            <div className="ad-card bg-grey text-center">
                                <div className="ad-card-body">
                                    ...
                                    <h4>Logistics</h4>
                                    <p className='pb-0'>Faster order fulfillment, reduced operational costs, and improved inventory management.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 mb-4">
                            <div className="ad-card bg-grey text-center">
                                <div className="ad-card-body">
                                    ...
                                    <p className='pb-0'>Improved inventory accuracy, enhanced customer service, and a more efficient retail environment.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 mb-4">
                            <div className="ad-card bg-grey text-center">
                                <div className="ad-card-body">
                                    ...
                                    <h4>Smart Cities</h4>
                                    <p className='pb-0'>Optimize urban living with affordable automation for superior smart city services.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-6">
                            <h1 className='h1_xxlarge text-center mb-4'>Try us</h1>
